        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?= base_url('dashboard/pengguna_edit_aksi') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="pengguna_id" value="<?= $pengguna->pengguna_id ?>">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control" placeholder="Nama" value="<?= $pengguna->pengguna_nama ?>" name="pengguna_nama">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Username" value="<?= $pengguna->pengguna_username ?>" name="pengguna_username">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="pengguna_level" name="pengguna_level" required>
                                            ...
                                            <option value="Pengunjung" <?= $pengguna->pengguna_level == "pengunjung" ? "selected" : "" ?>>Pengunjung</option>
                                            <option value="Admin" <?= $pengguna->pengguna_level == "admin" ? "selected" : "" ?>>Admin</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="" value="<?= $pengguna->pengguna_password ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
